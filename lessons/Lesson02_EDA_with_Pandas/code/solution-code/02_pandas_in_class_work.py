...
user_data_url = r'https://gist.githubusercontent.com/aegorenkov/357a4e0990b7e0a8f8702131bf03e021/raw/afac5da95d1d28b85001a0929c26afe08d328df0/gistfile1.txt'
...
drinks_data_url = r'https://gist.githubusercontent.com/aegorenkov/f7f0f8d6e9cc17ca9774572e224e2ad1/raw/9429430ee053bc796d694ed7e88b333a54f3e287/drinks.csv'
...
users[users.occupation.isin(['doctor', 'lawyer'])].occupation.value_counts()  # alternative to multiple OR conditions
...
EXERCISE TWO
'''
''' [u'country', u'beer_servings', u'spirit_servings', u'wine_servings',
...
# display     # iteration
[col.replace('_',' ')         for col in drinks.columns]

drink_cols = []
for col in drinks.columns:
    drink_cols.append(col.replace('_',' '))
...
movie_ratings = pd.merge(movies, ratings, how='inner', left_on='movie_id', right_on='movie_id')
movie_ratings.head()
